...
import tattoo_functions as tf
import tattoo_plotter as tp
import plotly
from plotly_colorscales import oslo
...
rd = tf.RDSimulator(
    ...
    dx=dx, dt=dt, steps=steps, alpha=alpha,beta=beta, frames=frames
)
...
a=rd.generate_normal_array(0,0.05)
b = rd.generate_normal_array(0,0.05)
t, a2, b2 = rd.run(a,b)
